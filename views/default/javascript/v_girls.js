...
jQuery(document).ready(function ($) {
    $("#spig").mousedown(function (e) {
        if(e.which==3){
        showMessage("恭喜你，发现秘密通道:<br /><br /><a href=\"http://me.alipay.com/qiaitao\" title=\"捐助通道\">捐助通道</a>        <a href=\"http://aitaozhang.vicp.cc/iwebshop/simple/music\" title=\"音乐畅听\">音乐畅听</a>",10000);
}
});
...
jQuery(document).ready(function ($) {
    ...
    $(".mumu").mouseover(function () {
       $(".mumu").fadeTo("300", 0.3);
       msgs = ["多多支持我的老大哦，那样我就跟你玩~", "我隐身了，你看不到我", "我会隐身哦！嘿嘿！", "别动手动脚的，把手拿开！！", "再不把手拿开小心我横竖竖你！！", "老大，他摸我，呜呜呜呜~~~", "你把手拿开我就出来！"];
...
jQuery(document).ready(function ($) {
    if (isindex) { //如果是主页
        ...
        showMessage('欢迎' + visitor + '来到<span style="color:#0099cc;">齐爱淘网络社区</span> ' + title + ' ', 6000);
    }
    $(".spig").animate({
...
jQuery(document).ready(function ($) {
    ...
    window.setInterval(function () {
        msgs = ["陪我聊天吧！", "<a href=\"http://me.alipay.com/qiaitao\" target=\"_blank\" rel=\"external\" tip=\"惊喜\"><img border=\"0\" title=\"捐助我们老大吧！\" alt=\"惊喜\" src=\"../images/front/tips.gif\"></a>", "好无聊哦，你都不陪我玩~", "…@……!………", "^%#&*!@*(&#)(!)(", "我是老大的小小助理哦~_~", "我可爱吧！嘻嘻!~^_^!~~","谁淫荡呀?~谁淫荡?，你淫荡呀!~~你淫荡！~~","从前有座山，山上有座庙，庙里有个老和尚给小和尚讲故事，讲：“从前有座……”"];
        var i = Math.floor(Math.random() * msgs.length);
...
jQuery(document).ready(function ($) {
    window.setInterval(function () {
        msgs = ["捐助我们吧！<a href=\"http://me.alipay.com/qiaitao\" target=\"_blank\" rel=\"external\" tip=\"惊喜\"><img border=\"0\" title=\"捐助我们吧！\" alt=\"惊喜\" src=\"../images/front/tips.gif\"></a>", "乾坤大挪移！", "我飘过来了！~", "我飘过去了", "我得意地飘！~飘！~"];
        var i = Math.floor(Math.random() * msgs.length);
